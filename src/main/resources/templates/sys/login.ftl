...
<head>
    ...
    <link href="/metronic_v3.4/admin/pages/css/login.css" rel="stylesheet" type="text/css"/>
...
<div class="content">
    <!-- BEGIN LOGIN FORM -->
    <form class="login-form" action="/sys/index.do" method="post">
        <h3 class="form-title">景区圈</h3>
    ...
    <form class="forget-form" action="/sys/index.do" method="post">
        <h3>忘记密码 ?</h3>
        <p>
            在下方输入你的电子邮件地址以重设密码
        </p>
        <div class="form-group">
            <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="邮件地址" name="email"/>
        </div>
        <div class="form-actions">
    ...
    <form class="register-form" action="/sys/index.do" method="post">
        <h3>注册</h3>
        <p class="hint">
            在下面输入您的个人资料：
        </p>
        ...
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">城/镇</label>
            <input class="form-control placeholder-no-fix" type="text" placeholder="城/镇" name="city"/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="重新输入密码" name="rpassword"/>
        </div>
...
<script src="/metronic_v3.4/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
...
<script src="/metronic_v3.4/admin/pages/scripts/login.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
