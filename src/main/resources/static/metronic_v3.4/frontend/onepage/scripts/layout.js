var Layout = function () {
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style-color').attr("href", "/static/metronic_v3.4/frontend/onepage/css/themes/" + color + ".css");
            $('.site-logo img').attr("src", "/static/metronic_v3.4/frontend/onepage/img/logo/" + color + ".png");
        }
