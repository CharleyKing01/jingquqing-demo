var Inbox = function () {
    ...
    var initWysihtml5 = function () {
        $('.inbox-wysihtml5').wysihtml5({
            "stylesheets": ["/static/metronic_v3.4/global/plugins/bootstrap-wysihtml5/wysiwyg-color.css"]
        });
    }
    ...
    var initFileupload = function () {
        ...
        $('#fileupload').fileupload({
            ...
            url: '/static/metronic_v3.4/global/plugins/jquery-file-upload/server/php/',
            autoUpload: true
        });
